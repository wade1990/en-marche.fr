...
Feature:
  ...
  Scenario: As a referent I can access the managed by referent adherents count information
    ...
    And the JSON nodes should be equal to:
      ...
      | male                                                | 5       |
      | total                                               | 8       |
      | adherents[0].date                                   | 2018-04 |
      | adherents[0].total                                  | 7       |
      | adherents[1].date                                   | 2018-03 |
      | adherents[1].total                                  | 7       |
      | adherents[2].date                                   | 2018-02 |
      | adherents[2].total                                  | 7       |
      | adherents[3].date                                   | 2018-01 |
      | adherents[3].total                                  | 7       |
      | adherents[4].date                                   | 2017-12 |
      | adherents[4].total                                  | 6       |
      | adherents[5].date                                   | 2017-11 |
      | adherents[5].total                                  | 6       |
      ...
      | email_subscriptions[0].date                         | 2018-04 |
      | email_subscriptions[0].subscribed_emails_local_host | 8       |
      | email_subscriptions[0].subscribed_emails_referents  | 8       |
      | email_subscriptions[1].date                         | 2018-03 |
      | email_subscriptions[1].subscribed_emails_local_host | 0       |
      | email_subscriptions[1].subscribed_emails_referents  | 0       |
      | email_subscriptions[2].date                         | 2018-02 |
      | email_subscriptions[2].subscribed_emails_local_host | 4       |
      | email_subscriptions[2].subscribed_emails_referents  | 0       |
      | email_subscriptions[3].date                         | 2018-01 |
      | email_subscriptions[3].subscribed_emails_local_host | 3       |
      | email_subscriptions[3].subscribed_emails_referents  | 0       |
      | email_subscriptions[4].date                         | 2017-12 |
      | email_subscriptions[4].subscribed_emails_local_host | 2       |
      | email_subscriptions[4].subscribed_emails_referents  | 0       |
      | email_subscriptions[5].date                         | 2017-11 |
      | email_subscriptions[5].subscribed_emails_local_host | 1       |
      | email_subscriptions[5].subscribed_emails_referents  | 0       |
  ...
  Scenario: As a referent I can access to my information
    ...
    And the JSON nodes should be equal to:
      ...
      | managedAreaTagCodes[0] | 75008                                |
      | managedAreaTagCodes[1] | 75009                                |
      | managedAreaTagCodes[2] | 75                                   |
      | managedAreaTagCodes[3] | 77                                   |
      | country                | FR                                   |
      | zipCode                | 75001                                |
  ...
  Scenario: As a logged-in user I can not set a nickname that used by another person
    ...
    And the JSON nodes should be equal to:
      ...
      | violations[0].propertyPath | nickname                                       |
      | violations[0].message      | Cette valeur est déjà utilisée.                |
  ...
  Scenario: As a logged-in user I cannot set my nickname if it's too long
    ...
    And the JSON nodes should be equal to:
      ...
      | violations[0].propertyPath | nickname                                              |
      | violations[0].message      | Vous devez saisir au maximum 25 caractères.           |
